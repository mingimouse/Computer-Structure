...
1. 0에 2의 보수를 취해주면, 올림수가 발생한다.<br>

2. 2<sup>n</sup> 에 2의 보수를 취해주면, 자기 자신이 되어버린다.<br>

3. 이진수를 보고 이것이 양수인지, 음수인지 구분하기 힘들다.<br>(0101<sub>(2)</sub>이 5<sub>(10)</sub>를 표현한 것인지, 1011<sub>(2)</sub>의 음수를 표현한 것인지 구분이 어렵다)<br>
